...
import { BonusRulesPage } from './pages/masters/BonusRulesPage';
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="masters/bonus-rules" element={<BonusRulesPage />} />
          ...
          <Route path="import/opening-balances" element={<ImportOpeningBalancesPage />} />
