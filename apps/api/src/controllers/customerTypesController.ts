...
export async function createCustomerType(req: Request, body: CreateCustomerTypeInput): Promise<ControllerResult> {
...
export async function updateCustomerType(req: Request, body: UpdateCustomerTypeInput): Promise<ControllerResult> {
  const repo = CustomerType.getRepository();
